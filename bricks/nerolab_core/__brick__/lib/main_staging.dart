...
import 'package:{{#snakeCase}}{{project_name}}{{/snakeCase}}/core/env/flavor.dart';
import 'package:{{#snakeCase}}{{project_name}}{{/snakeCase}}/presentation/app/app.dart';
import 'package:{{#snakeCase}}{{project_name}}{{/snakeCase}}/presentation/app/app_bloc_observer.dart';
