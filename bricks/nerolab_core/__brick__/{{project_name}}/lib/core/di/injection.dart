import 'package:{{#snakeCase}}{{project_name}}{{/snakeCase}}/core/env/env_config.dart';
import 'package:{{#snakeCase}}{{project_name}}{{/snakeCase}}/core/network/http_client.dart';
...
import 'package:{{#snakeCase}}{{project_name}}{{/snakeCase}}/data/auth/repositories/repository_impl.dart';
