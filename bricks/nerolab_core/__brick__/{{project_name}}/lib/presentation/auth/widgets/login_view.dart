...
import 'package:{{#snakeCase}}{{project_name}}{{/snakeCase}}/core/constants/assets_constants.dart';
import 'package:{{#snakeCase}}{{project_name}}{{/snakeCase}}/core/l10n/localizations.dart';
import 'package:{{#snakeCase}}{{project_name}}{{/snakeCase}}/core/utils/ui/widgets/loading_with_text.dart';
import 'package:{{#snakeCase}}{{project_name}}{{/snakeCase}}/core/utils/ui/widgets/snackbar.dart';
...
import 'package:{{#snakeCase}}{{project_name}}{{/snakeCase}}/presentation/auth/widgets/login_form.dart';
